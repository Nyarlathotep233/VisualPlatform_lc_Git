...
function Setup(builder, id) {
    ...
    this.origin = parse_xform(el.getAttribute("origin"));
    this.mount_ref = parse_xform(el.getAttribute("mount_ref"));
    this.workpiece_ref = parse_xform(el.getAttribute("workpiece_ref"));;

    var ref = el.getAttribute("geometry");
    if (ref) 
