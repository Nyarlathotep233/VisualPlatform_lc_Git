...
{
    this.load_queue = [];  // The queue of requests to load 请求加载的队列
    this.loading = [];     // Items currently getting loadend  项目目前加载结束

    this.post_queue = [];  // The queue of post-loading jobs to perform	执行加载工作的队列
...
//	console.log ("Target="+this.base);
    ...
    //url:null
    //fn:Object { use_count: 1, id: "id6248", href: null }
    //sort:undefined

	url = resolve_url(url, this.base, "index.xml");
