...
//            window.console.log(opts);
            ...
            var objects = [ 'unpin','reload', 'expand', 'minimize','close'];
...
//            css['position'] = 'absolute';
        ...
        close: function (animationDuration) {
           ...
           */
        	var me = this;
        	var div=me.$body[0];
        	div_id=div.getAttribute("id");//默认panel-body的id只有一个，当div的id>1时需考虑多个id的情况
	        if(div_id=="nodeContainer")
	        	$(".but1").click();
	        else if(div_id=="container")
	        	$(".but3").click();
	        else if(div_id=="featureContainer")
	        	$(".but4").click();
        },
