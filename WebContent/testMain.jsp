...
<html lang="en">
    <head>
		...
		fieldset,input,textarea,p,blockquote,th,td {   
			...
			#rightMenu3{top:-9999px;left:-9999px;position:absolute;}
			#rightMenu3 ul{float:left;border:1px solid #979797;background:#f1f1f1 url(http://js.fgm.cc/learn/lesson6/img/line.png) 24px 0 repeat-y;padding:2px;box-shadow:2px 2px 2px rgba(0,0,0,.6);}
			#rightMenu3 ul li{float:left;height:24px;cursor:pointer;line-height:24px;white-space:nowrap;padding:0 0px;text-align:center;}
			#rightMenu3 ul li.sub{background-repeat:no-repeat;background-position:right 9px;background-image:url(http://js.fgm.cc/learn/lesson6/img/arrow.png);}
			#rightMenu3 ul li.active{background-color:#f1f3f6;border-radius:3px;border:1px solid #aecff7;height:22px;line-height:22px;background-position:right -8px;padding:0 0px;}
			#rightMenu3 ul ul{display:none;position:absolute;}
			#rightMenu4{top:-9999px;left:-9999px;position:absolute;}
			#rightMenu4 ul{float:left;border:1px solid #979797;background:#f1f1f1 url(http://js.fgm.cc/learn/lesson6/img/line.png) 24px 0 repeat-y;padding:2px;width:502px}
			...
			.left-bottons{
 			...
 			.leftbuttons {
				background-color:rgb(241, 211, 35); 
				border: none;
				color: black;
				text-align: center;
			...
			.left-botton{flex: 0 1 100px;font-size:15px;font-weight:bold;height:50px;}
			.right-botton{flex: 0 1 100px;font-size:15px;font-weight:bold;height:50px;}
			...
			#showAttributes4 {border:1px solid #979797;background:#f1f1f1 url(http://js.fgm.cc/learn/lesson6/img/line.png);padding: 2px;}
			#showAttributes4 span {padding-left: 27px;height:32px;display: block;border-top:2px solid #979797;}
			#showAttributes4 span select {width:150px;text-align:center;height:30px}
		</style>
    </head>
    <body>
        <!-- Start #header -->
                    ...
                    <div class="row">
                        ...
                        <div class="special1 col-lg-5 col-md-5 sortable-layout resizable" id="one" style="display:none;">
                            ...
                            <div class=" panel panel-teal panel1">
                                ...
                                <div id="nodeContainer" class="panel-body" style="padding:0px;">
                                </div>
                                <div class="panel-footer" id="afternodeContainer">面板脚注
                        ...
                        <div class="col-lg-5 col-md-5 sortable-layout" id="two" style="display:none;">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"><i class="im-bars"></i>尺寸关系图
						 ...
						 <div class="special3 col-lg-5 col-md-5 sortable-layout" id="three" style="display:none;">
                            ...
                            <div class="panel panel-brown">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title"><i class="im-bars"></i>三维展示
						 ...
						 <div class="col-lg-5 col-md-5 sortable-layout" id="four"  style="display:none;">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div id="featureContainer" class="panel-body" style="padding:0px;">
                                </div>
                                <div class="panel-footer">面板脚注
												...
												<form action="#" method="get">
													<div id="feature_one" class="feature_cla">
														...
														<div class="right_feature_cla">
															...
															</span> <span class="val_cla">盲孔(<span id="blind_hole">0</span>)
															</span>
														</div>
													</div>
													<div id="feature_two" class="feature_cla">
														...
														<div class="right_feature_cla">
															...
															</span> <span class="val_cla">立方凸台(<span id="cube_convex_plate">0</span>)
															</span> <span class="val_cla">圆柱凸台(<span
																id="cylinder_convex_plate">0</span>)
															</span>
														</div>
													</div>
													<div id="feature_three" class="feature_cla">
														...
														<div class="right_feature_cla">
															...
															</span> <span class="val_cla">T型槽(<span id="T_groove">0</span>)
															</span> <span class="val_cla">直方槽(<span id="rectangular_groove">0</span>)
															</span> <span class="val_cla">V型槽(<span id="V_groove">0</span>)
															</span> <span class="val_cla">通槽(<span id="through_groove">0</span>)
															</span> <span class="val_cla">燕槽(<span id="swallowing_groove">0</span>)
															</span>
														</div>
													</div>
													<div id="feature_four" class="feature_cla">
														...
														<div class="right_feature_cla">
															...
															</span> <span class="val_cla">平面(<span id="sub_plane">0</span>)
															</span>
														</div>
													</div>
													<div id="feature_five" class="feature_cla">
														...
														<div class="right_feature_cla">
															...
															</span> <span class="val_cla">圆角(<span id="fillet">0</span>)
															</span>
														</div>
													</div>
													<div id="feature_six" class="feature_cla">
														...
														<div class="right_feature_cla">
															...
															</span> <span class="val_cla">阶梯槽(<span id="ladder_groove">0</span>)
															</span>
														</div>
													</div>
												</form>
											</div>
							    		<div id="showAttributes4">  
							    		</div>  
							 		</div>	 
					            </div>
                            </div>
						 ...
						 <div class="col-lg-5 col-md-5 sortable-layout" id="five"  style="display:none;">
                            ...
                            <div class="panel panel-warning">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title" style="font-size:30px;font-weight:bold;"><i class="im-bars"></i>design intent
                                ...
                                <div class="design_body" id="design">
                                	<div class="left-bottons">
										<button class="leftbuttons" id="buttona" style="width:60px;">规则写入</button>
										<button class="leftbuttons" id="buttonb" style="width:60px;">规则挖掘</button>
										<button class="leftbuttons" id="buttonc" style="width:60px;">约束尺寸</button>
										<button class="leftbuttons" id="buttond" style="width:60px;">特征信息</button>
										<button class="leftbuttons" id="buttone" style="width:60px;">设计历史</button>
                                	</div>
                                	<div class="right-show">
										<div  id="show1">
											<div class="inputtext" style="padding:30px 0px 0px 10px;" >
													<textarea  id="inputrule" style="font-size:25px;vertical-align:top;width:95%;height:95%;resize:none" placeholder="请输入规则"></textarea>
											</div>
											<div class="importtolib">
												<button class="buttons left-botton" id="leftbutton" >本地规则库</button>
												<button class="buttons right-botton" id="rightbutton">远程规则库</button>
											</div>
										</div>
										<div  id="show2">
											<div class="warning"><div>提示：系统将使用增强学习进行规则挖掘，请输入相应状态空间并耐心等候！</div></div>
											<div class="inputtexts" >
												<form>
													<p style="margin:0px 65px;">
														...
														<button class="buttons left-botton" id="startRL" style="height:40px;">开始</button>
													</p>
												</form>
											...
											<div class="showrules">
												<ul class="rule_ul">
													<li class="rule_li">DIMENSIONAL_CHARACTERISTIC_REPRESENTATION_</li>	
													<li class="rule_li">contains_DIMENSIONAL_LOCATION(?d,?l)∧</li>		
													<li class="rule_li">DIMENSIONAL_LOCATION_</li>	
													<li class="rule_li">_contains_SHAPE_ASPECT(?l,?s)∧</li>	
													<li class="rule_li">SHAPE_ASPECT_contains^(-1)</li>	
													<li class="rule_li">_GEOMETRIC_ITEM_SPECIFIC_USAGE(?s,?g)∧</li>	
													<li class="rule_li">GEOMETRIC_ITEM_SPECIFIC_USAGE</li>	
													<li class="rule_li">_contains_ADVANCED_FACE(?g,?a)∧</li>	
													<li class="rule_li">ADVANCED_FACE_contains^(-1)_CLOSED_SHELL(?a,?c)</li>	
													<li class="rule_li">→</li>	
													<li class="rule_li">CLOSED_SHELL_has_PMI(?c)</li>										
												</ul>
											</div>
											<div class="importtolib">
												<button class="buttons left-botton" id="storetolib" >存入规则库</button>
												<button class="buttons right-botton" id="abandom" >放弃规则库</button>
											</div>
										...
										<div  id="show3">
											<div class="topbuttons" >
												<button class="buttons left-botton" id="weidu">维度约束</button>
												<button class="buttons right-botton" id="zhuangpei">装配约束</button>
											</div>
											<div class="weidulimit" >
												<ul class="box" id="box1">											
												</ul>
												<button class="go" id="go" style="height:40px;width:100px;">三维关联</button>
											</div>
										...
										<div id="show4">
											...
											<div class="rest">
												<ul class="show4box" id="show4ul" style="margin:50px 0;">									
												</ul>
											</div>
	...
	$(function(){
  		$('#buttonc').click(function(){   		
			...
			li[2] = $("<li>CLOSED_SHELL_has_CYLINDRICITY_TOLERANCE(?#1060?#30)</li>");
			li[3] = $("<li>传动轴具有圆柱度约束信息；</li>");
			li[4] = $("<li>CLOSED_SHELL_has_CIRCULAR_RUNOUT_TOLERANCE(?#1060?#22)</li>");
			li[5] = $("<li>传动轴具有圆跳动约束信息；</li>");
			li[6] = $("<li>CLOSED_SHELL_has_LINEAR_PMI(?#1060?#62)\nLINEAR_PMI_relation_ADVANCED_FACE(?#62,?#1039)\nLINEAR_PMI_relation_ADVANCED_FACE(?#62,?#1037)\nSPECIAL_TYPE_has_LINEAR_PMI_VALUE(?#77?12)</li>");
			li[7] = $("<li>传动轴具有PMI线性尺寸信息，该线性尺寸信息关联面为#1039和#1037面，且该线性尺寸信息值为12mm；</li>");
			li[8] = $("<li>CLOSED_SHELL_has_RADIAL_PMI(?#1060?#47)\nRADIAL_PMI_relation_ADVANCED_FACE(?#47,?#1030)\nSPECIAL_TYPE_has_RADIAL_PMI_VALUE(?#80?55)</li>");
			li[9] = $("<li>传动轴具有PMI径向尺寸信息，该径向尺寸信息关联面为#1030，且径向尺寸为55mm</li>");
	...
	$(function(){
  		$('#buttond').click(function(){   	
			...
			var li = new Array;
			li[0] = $("<li>传动轴</li>");
			li[1] = $("<li><button class=\"show4ul_button\">不规则槽特征</button></br><button class=\"show4ul_button\">不规则开槽特征</button></br><button class=\"show4ul_button\">圆柱凸台特征</button></li>");
			for(var i=0 ; i<li.length;i++){
	...
	$(function(){
  		$('#buttone').click(function(){   
			...
			$("#show5 div").remove();
			var div1 = $("<div class=\"results\"><div style=\"text-align:center;font-size:20px;flex:0 1 auto;\">可能结果1</div><div class=\"resultbuttons\"><button class=\"resultbutton\">凸台-拉伸</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">凸台-拉伸</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">凸台-拉伸</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">凸台-拉伸</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">不规则槽特征-切除拉伸</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">凸台-拉伸</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">凸台-拉伸</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">凸台-拉伸</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">不规则开槽特征-切除拉伸</button></div></div>");
			div1.appendTo("#show5");
			var div2 = $("<div class=\"results\"><div style=\"text-align:center;font-size:20px;flex:0 1 auto;\">可能结果2</div><div class=\"resultbuttons\"><button class=\"resultbutton\">草图-旋转</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">不规则槽特征-切除拉伸</button><div class=\"arrows\"><img class=\"arrowimg\" src=\"./images/right_arrow.png\" /></div><button class=\"resultbutton\">不规则开槽特征-切除拉伸</button></div></div>");
			div2.appendTo("#show5");
  		})
	})
	$(function(){
	...
	$(document).ready(function(e) {
		...
		$(".show_anno").click(function(e) {//三位展示div中的显示标注按钮
			show_anno();
			});
		$(".hide_anno").click(function(e) {//三位展示div中的显示标注按钮
			remove_anno();
			});	
