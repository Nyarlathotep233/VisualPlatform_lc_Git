...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="ww/font-awesome-4.3.0/css/font-awesome.min.css"
    />
        ...
        <div class="navbar">
          <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
              ...
              ><span class="text-logo">可视化</span
              ><span class="text-slogan">平台</span>
            </a>
          </div>
          <!-- 上方导航菜单左侧 -->
    ...
    <div id="content">
      ...
      <div class="content-wrapper">
        <div class="row">
          <!-- Start .row -->
          <div
            class="special1 col-lg-5 col-md-5 sortable-layout resizable"
            id="one"
            style="display: none"
          >
            <!-- Start col-lg-5 -->
          ...
          <!-- End col-lg-5 -->
          <div
            class="col-lg-5 col-md-5 sortable-layout"
            id="two"
            style="display: none"
          >
            <!-- Start col-lg-5 -->
          ...
          <div
            class="special3 col-lg-5 col-md-5 sortable-layout"
            id="three"
            style="display: none"
          >
            <!-- Start col-lg-5 -->
                    ...
                    <form action="#" method="get">
                      <div id="feature_one" class="feature_cla">
                        ...
                        <div class="right_feature_cla">
                          <span class="val_cla"
                            >通孔(<span id="through_hole">0</span>)
                          </span>
                          <span class="val_cla"
                            >盲孔(<span id="blind_hole">0</span>)
                          </span>
                        </div>
                      </div>
                      <div id="feature_two" class="feature_cla">
                        ...
                        <div class="right_feature_cla">
                          <span class="val_cla"
                            >一般凸台(<span id="normal_convex_plate">0</span>)
                          </span>
                          <span class="val_cla"
                            >立方凸台(<span id="cube_convex_plate">0</span>)
                          </span>
                          <span class="val_cla"
                            >圆柱凸台(<span id="cylinder_convex_plate">0</span>)
                          </span>
                        </div>
                      </div>
                      <div id="feature_three" class="feature_cla">
                        ...
                        <div class="right_feature_cla">
                          <span class="val_cla"
                            >开槽(<span id="open_groove">0</span>)
                          </span>
                          <span class="val_cla"
                            >T型槽(<span id="T_groove">0</span>)
                          </span>
                          <span class="val_cla"
                            >直方槽(<span id="rectangular_groove">0</span>)
                          </span>
                          <span class="val_cla"
                            >V型槽(<span id="V_groove">0</span>)
                          </span>
                          <span class="val_cla"
                            >通槽(<span id="through_groove">0</span>)
                          </span>
                          <span class="val_cla"
                            >燕槽(<span id="swallowing_groove">0</span>)
                          </span>
                        </div>
                      </div>
                      <div id="feature_four" class="feature_cla">
                        ...
                        <div class="right_feature_cla">
                          <span class="val_cla"
                            >台阶(<span id="step_plane">0</span>)
                          </span>
                          <span class="val_cla"
                            >平面(<span id="sub_plane">0</span>)
                          </span>
                        </div>
                      </div>
                      <div id="feature_five" class="feature_cla">
                        ...
                        <div class="right_feature_cla">
                          <span class="val_cla"
                            >倒角(<span id="chamfer">0</span>)
                          </span>
                          <span class="val_cla"
                            >圆角(<span id="fillet">0</span>)
                          </span>
                        </div>
                      </div>
                      <div id="feature_six" class="feature_cla">
                        ...
                        <div class="right_feature_cla">
                          <span class="val_cla"
                            >阶梯孔(<span id="ladder_hole">0</span>)
                          </span>
                          <span class="val_cla"
                            >阶梯槽(<span id="ladder_groove">0</span>)
                          </span>
                        </div>
                      </div>
                    </form>
                        ...
                        <form>
                          <p style="margin: 0px 65px">
                            ...
                            <input
                              id="inputstart"
                              type="text"
                              style="width: 45px; margin: 5px 15px"
                            />
                            <lable>终点空间状态:</lable>
                            <input
                              id="inputend"
